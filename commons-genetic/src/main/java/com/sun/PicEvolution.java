...
public class PicEvolution {
     ...
     * @param toEvo
     * @param standard
     * @param maxSize  种群数量(繁衍后被自然淘汰后保持的数量)
     * @param maxAge   最大繁衍代数
     * @param xSize
     * @param ySize
     * @return
     ...
     *
     * @param pics          已有的种群
     * @param evoSize       繁殖的种群数量
     * @param mutationLevel 突变的数量级(越大突变的基因就越少)
     * @param xSize
     * @param ySize
     * @return
     */
    ...
    public static void create(Pic standard, int width, int height) throws Exception {
        ...
        while (true) {
            ...
            if (gen % Math.pow(2, i) == 0) {
                i++;
                File fileW = new File(path + "/evo/" + name + gen + ".jpg");
    ...
    public static String path = "commons-genetic/src/main/resources";
    public static String name = "firefox";

    public static void main(String[] args) throws Exception {
        File file = new File(path + "/" + name + "64.jpg");
